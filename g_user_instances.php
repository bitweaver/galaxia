...
// $Header: /cvsroot/bitweaver/_bit_galaxia/g_user_instances.php,v 1.8 2009/10/01 14:16:59 wjames5 Exp $
...
$items = $GUI->gui_list_user_instances($gBitUser->getUserId(), $offset, $max_records, $sort_mode, $find, $where);
