...
// $Header: /cvsroot/bitweaver/_bit_galaxia/g_monitor_instances.php,v 1.9 2010/02/08 21:27:22 wjames5 Exp $
...
$items = $processMonitor->monitor_list_instances($offset, $max_records, $sort_mode, $find, $where);
...
$gBitSystem->display( 'bitpackage:Galaxia/g_monitor_instances.tpl', tra('Monitor Instances') , array( 'display_mode' => 'display' ));
