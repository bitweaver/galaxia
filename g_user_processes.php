...
// $Header: /cvsroot/bitweaver/_bit_galaxia/g_user_processes.php,v 1.10 2010/02/08 21:27:22 wjames5 Exp $
...
$items = $GUI->gui_list_user_processes($gBitUser->getUserId(), $offset, $max_records, $sort_mode, $find, $where);
...
$gBitSystem->display( 'bitpackage:Galaxia/g_user_processes.tpl', tra('User Processes') , array( 'display_mode' => 'display' ));
