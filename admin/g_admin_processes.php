...
// $Header: /cvsroot/bitweaver/_bit_galaxia/admin/g_admin_processes.php,v 1.9 2010/02/08 21:27:22 wjames5 Exp $
...
$items = $processManager->list_processes($offset, $max_records, $sort_mode, $find, $where);
