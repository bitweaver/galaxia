...
// $Header: /cvsroot/bitweaver/_bit_galaxia/admin/g_admin_instance.php,v 1.5 2008/06/25 22:21:10 spiderr Exp $
...
/*if (!isset($_REQUEST['aid'])) {
	$gBitSmarty->assign('msg', tra("No activity indicated"));
...
$gBitSystem->display( 'bitpackage:Galaxia/g_admin_instance.tpl', tra("Admin Instance") , array( 'display_mode' => 'admin' ));
