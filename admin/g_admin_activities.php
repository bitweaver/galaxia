...
// $Header: /cvsroot/bitweaver/_bit_galaxia/admin/g_admin_activities.php,v 1.9 2010/02/08 21:27:22 wjames5 Exp $
...
$gBitSystem->display( 'bitpackage:Galaxia/g_admin_activities.tpl', tra('Admin Activites') , array( 'display_mode' => 'admin' ));
