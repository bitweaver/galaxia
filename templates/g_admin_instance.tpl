...
<tr class="panelsubmitrow"><td colspan="2">
	<input type="submit" class="btn btn-default" name="save" value="{tr}update{/tr}" />
</td></tr>
</table>
</form>
...
{/foreach}
<tr class="panelsubmitrow"><td colspan="2">
	<input type="submit" class="btn btn-default" name="saveprops" value="{tr}update{/tr}" />
</td></tr>
</table>
</form>
...
<tr class="panelsubmitrow"><td colspan="2">
	<input type="submit" class="btn btn-default" name="addprop" value="{tr}add{/tr}" />
</td></tr>
</table>
</form>
</div>
