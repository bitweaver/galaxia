...
{if count($roles) > 0}
	...
	<tr>
		<td>{tr}Map{/tr}</td><td>
		  <table border="1">
		  	<tr>
				...
				<input type="submit" class="btn btn-default" name="findusers" value="{tr}filter{/tr}" />
		  		</td>
		  		<td>{tr}Roles{/tr}:</td>
		  	</tr>
		  	<tr>
		...
		<td colspan="2">
			<input type="submit" class="btn btn-default" name="save" value="{tr}map{/tr}" />
		</td>
	</tr>
	</table>
	</form>
...
<input type="submit" class="btn btn-default" name="filter" value="{tr}find{/tr}" />
</form>
...
<table>
<tr>
<th><input type="submit" class="btn btn-default" name="delete" value="{tr}Delete{/tr}" /></th>
