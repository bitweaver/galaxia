...
<tr class="panelsubmitrow"><td colspan="2">
	{if $acts.actstatus eq 'running'}<input type="submit" class="btn btn-default" name="save" value="{tr}update{/tr}" />{/if}
</td></tr>
</table>
</form>
...
<tr>
	...
	<form action="{$smarty.const.GALAXIA_PKG_URL}admin/g_admin_instance_activity.php" method="post">
		<input type="submit" class="btn btn-default" name="eraser" value="{tr}erase{/tr}" />
...
<tr class="panelsubmitrow"><td colspan="2">
	<input type="submit" class="btn btn-default" name="answer" value="{tr}Save{/tr}"/></td>
</tr>
</table>
